...
insert into categorias_unidad_medida (codigo_cudm , nombre) values('U', 'Unidades');
insert into categorias_unidad_medida (codigo_cudm , nombre) values('V', 'Volumen');
insert into categorias_unidad_medida (codigo_cudm , nombre) values('P', 'Peso');
...
create table unidades_medida(
	...
	constraint categoria_udm_fk foreign key (categoria_udm) references categorias_unidad_medida(codigo_cudm)
);
...
create table productos(
	...
	constraint udm_fk foreign key (udm) references unidades_medida(codigo_udm),
	constraint categoria_fk foreign key (categoria) references categorias(codigo_cat)
);
...
create table proveedores(
	...
	constraint tipo_documento_fk foreign key (tipo_documento) references tipo_documento(codigo_doc)
);
...
insert into estados_pedido (codigo_est , descripcion) values('S', 'Solicitado');
insert into estados_pedido (codigo_est , descripcion) values('R', 'Recibido');
...
insert into cabecera_pedido (proveedor, fecha, estado) values('1792285747', '6/11/2024','R'),
...
insert into cabecera_ventas (fecha, total_sin_iva, iva, total) values('6/11/2024', 3.26, 0.39, 3.65);
...
insert into historial_stock (fecha, referencia, producto, cantidad) 
					values ('6/11/2024 19:59', 'Pedido 1', 1, 100),
							('6/11/2024 19:59', 'Pedido 1', 4, 50),
							('6/11/2024 20:00', 'Pedido 2', 1, 10),
							('6/11/2024 20:00', 'Venta 1', 1, -5),
							('6/11/2024 20:00', 'Venta 1', 4, 1);
